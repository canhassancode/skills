...
- **Triage-graph lane** (`triage`) reads a `tracker:` preference from the repo's `CLAUDE.md` and loads a global adapter (`~/.claude/skills/triage/issue-tracker-<tracker>.md`). GitHub and Linear only.
