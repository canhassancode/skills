...
- **Mark duplicate**: `glab issue note <number> --message "/duplicate #<survivor>"`. The `/duplicate` quick action closes the issue and links it to the survivor, and GitLab's system note names the survivor.
