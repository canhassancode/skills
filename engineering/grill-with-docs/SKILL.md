...
| **Proposal**         | an argued recommendation for a decision-maker (your manager, a stakeholder) | `/propose` → tracker, ticket left at `awaiting-decision`     |
