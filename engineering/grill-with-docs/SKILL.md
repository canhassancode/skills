...
Offer the user a choice before exploration: parallel fan-out via subagents
(scout + ask + researcher) or linear exploration. Default to linear if
subagents are unavailable or the user doesn't answer.
