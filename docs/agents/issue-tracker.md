...
- **Mark duplicate**: `gh issue close <number> --duplicate-of <survivor> --comment "Duplicate of #<survivor>"`. The comment names the survivor, so reopening the issue and clearing the relation undoes it.
